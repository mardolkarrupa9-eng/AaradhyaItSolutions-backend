...
export const companyInfoTable = pgTable('company_info', {
  ...
  support_phone1:       varchar('support_phone1', { length: 20 }),
  support_phone2:       varchar('support_phone2', { length: 20 }),
  support_phone3:       varchar('support_phone3', { length: 20 }),
  sales_phone1:         varchar('sales_phone1', { length: 20 }),
  sales_phone2:         varchar('sales_phone2', { length: 20 }),
  ...
  custom_socials:       text('custom_socials'),
  hours_weekday:        varchar('hours_weekday', { length: 50 }).default('9:00 AM - 7:00 PM'),
  hours_weekday_open:   boolean('hours_weekday_open').default(true),
  hours_saturday:       varchar('hours_saturday', { length: 50 }).default('10:00 AM - 5:00 PM'),
  hours_saturday_open:  boolean('hours_saturday_open').default(true),
  hours_sunday:         varchar('hours_sunday', { length: 50 }).default('Closed'),
  hours_sunday_open:    boolean('hours_sunday_open').default(false),
});
