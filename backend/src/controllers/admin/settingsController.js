...
export const updateCompany = async (req, res) => {
  try {
    const data = {
      ...
      support_phone1:      req.body.supportPhone1,
      support_phone2:      req.body.supportPhone2,
      support_phone3:      req.body.supportPhone3,
      sales_phone1:        req.body.salesPhone1,
      sales_phone2:        req.body.salesPhone2,
      ...
      custom_socials:      req.body.customSocials,
      logo_path:           req.body.logoPath,
      hours_weekday:       req.body.hoursWeekday,
      hours_weekday_open:  req.body.hoursWeekdayOpen,
      hours_saturday:      req.body.hoursSaturday,
      hours_saturday_open: req.body.hoursSaturdayOpen,
      hours_sunday:        req.body.hoursSunday,
      hours_sunday_open:   req.body.hoursSundayOpen,
    };
